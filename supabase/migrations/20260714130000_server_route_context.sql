...
REVOKE EXECUTE ON FUNCTION public.get_server_route_context () FROM public;
REVOKE EXECUTE ON FUNCTION public.get_server_route_context () FROM anon;
GRANT EXECUTE ON FUNCTION public.get_server_route_context () TO authenticated;
