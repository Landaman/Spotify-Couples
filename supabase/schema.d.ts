...
export interface Database {
	...
	public: {
		...
		Functions: {
			...
			get_server_route_context: {
				Args: never;
				Returns: Database['public']['CompositeTypes']['server_route_context'];
				SetofOptions: {
					from: '*';
					to: 'server_route_context';
					isOneToOne: true;
					isSetofReturn: false;
				};
			};
		...
		CompositeTypes: {
			...
			server_route_context: {
				partner_id: string | null;
				play_refresh_needed: boolean | null;
			};
		};
	};
}
