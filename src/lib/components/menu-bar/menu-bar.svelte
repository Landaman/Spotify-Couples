...
<header
	class={`flex w-full flex-row justify-between border-b border-border/40 bg-background/95 px-4 py-3 backdrop-blur supports-[backdrop-filter]:bg-background/60 md:px-8 ${className ?? ''}`}
>
	<a href="/">
